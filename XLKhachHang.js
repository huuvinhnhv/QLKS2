...
function DocDuLieuPhong() {
    ...
    try {
        ...
        console.error("Đã xảy ra lỗi khi đọc dữ liệu phòng từ thư mục:", thuMucChuaFilesPhong, error);
        return [];
    }
}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary px-3" style="min-height: 8vh;">
    ...
    <form class="form-inline mx-1" method="get" action="/timkiem">
        <label class="text-white mx-3">Loại phòng: </label>
    ...
    <button type="button" class="btn btn-light ml-auto" data-toggle="modal" data-target="#loginModal">
        Đăng nhập
    </button>
</nav>
`
...
module.exports.TaoMenuKhachHang = TaoMenuKhachHang;
